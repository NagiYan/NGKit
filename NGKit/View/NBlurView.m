...
@implementation UIImage (NBlurView)
...
- (void)setBlurEnabled:(BOOL)blurEnabled
{
    ...
    if (blurEnabled)
    {
        for (NBlurView *view in self.views)
        {
...
- (void)removeView:(NBlurView *)view
{
